...
<nav id="sidebar" class='mx-lt-5'>
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=main_desk" class="nav-item nav-main_desk"><span class='icon-field'><i class="fa fa-info-circle"></i></span> Main Desk</a>	
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span>Organisation</a>							
			<?php endif; ?>
		</div>
